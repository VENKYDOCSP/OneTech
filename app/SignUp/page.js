        ...
        <div className='col-lg-3 col-md-4 col-12 d-flex  flex-column text-light ' style={{background: "linear-gradient(180deg, #59599B 0%, #24243E 59.38%, #0F0C29 100%)",height:"100vh"}}>
                  ...
                  <div className='d-flex flex-column gap-3 justify-content-center align-items-center mt-md-5 pt-3 '> 
                      ...
                      <div className='text-center mt-4'>
                        ...
                        <p>You can  <span> <Link href="SignIn" className='text-decoration-none fw-bolder' style={{color:"#4D47C3"}}> Login here !</Link></span> </p>
                      </div>
                    </div>
              </div>
          <div className='col-lg-9 col-md-8 col-12 d-flex flex-column justify-content-center align-items-center'> 
          <h2 className='fw-bold mb-4 mt-3'>Sign Up</h2>
          <form className='col-lg-5 col-md-8 col-10' onSubmit={submitHandle} >
          <div class="form-floating mb-3" >
            <input type="email" class="form-control border-0 ps-4" id="floatingInput" placeholder="name@example.com" required/>
            <label for="floatingInput" className='ps-4'>Email address</label>
          </div>

          <div class="form-floating  mb-3">
            <input type="text" class="form-control border-0 ps-4" id="floatingUserName" placeholder="Create User name" required />
            <label for="floatingUserName" className='ps-4'>User Name</label>
          </div>

          <div class="form-floating  mb-3">
            <input type="tel" class="form-control border-0 ps-4" id="floatingContact" placeholder="Contact number" required />
            <label for="floatingContact" className='ps-4'>Contact number</label>
          </div>

          <div class="form-floating  mb-3 d-flex">
            <input type={Toggle} class="form-control border-0 ps-4" id="floatingSetPassword" placeholder="Password" onChange={(e)=>{SetPassword(e.target.value)}} required />
            <label for="floatingPassword" className='ps-4'>Password </label>
            
            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" className='position-absolute' style={{bottom:"30%",right:"8%",cursor:"pointer"}} onClick={ShowPassword}>
          ...
          <div class="form-floating  mb-3 d-flex">
            <input type="password" class="form-control border-0 ps-4" id="floatingSetPassword1" placeholder="Confrim Password" required />
            <label for="floatingPassword" className='ps-4'>Confrim Password </label>
          ...
          <button type="submit" class="btn  col-lg-8 col-md-10 col-10 text-light "  >Register</button>
          </div>
